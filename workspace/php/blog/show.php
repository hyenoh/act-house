...
<ul class="show_breadcrumbs">
  ...
  <?php else : ?>
    <div calss="pre_nex">
      <?php
        ...
        <a href="show.php?id=<?php echo $prev_id; ?>" class="pre"><前の記事</a>
        <?php endif; ?>
        <?php
        ...
        <a href="show.php?id=<?php echo $next_id; ?>" class="nex">次の記事></a>
        <?php endif; ?>
    </div>
  ...
  <img src="image.php?id=<?php echo $id; ?>" alt="" class="image_show">
  </div>
